...
it('can add the star name and star symbol properly', async() => {
    ...
    let instance = await StarNotary.deployed();
    let starId = 8;
    await instance.createStar('symbol star', starId, {from: accounts[1]});
...
it('lets 2 users exchange stars', async() => {
    ...
    let star1Id = 11;
    let star2Id = 22;
    await instance.createStar('User1 star', star1Id, {from: user1});
    await instance.createStar('User2 star', star2Id, {from: user2});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let user1 = accounts[1];
    let star1Id = 76;
    await instance.createStar('lookup star', star1Id, {from: user1});
    // 2. Call your method lookUptokenIdToStarInfo
    const starName = await instance.lookUptokenIdToStarInfo(star1Id, {from: user1});
